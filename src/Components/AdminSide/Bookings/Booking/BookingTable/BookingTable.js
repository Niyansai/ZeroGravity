      ...
      <div className="container-fluid pm-table-search">
        <div className="row pm-table-row-1">
          ...
          <div className="col-lg-3 col-md-3 col-sm-12 ad-rw2-col-2-row-1-col-4">
            <Link to="/bookings/add"><button onClick={addBooking} className="btn-delete-adb pm-add-btn"><AddIcon /><span>ADD BOOKING</span></button></Link>
          </div>
            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow className="table-details-pm" key={index}>
                  ...
                  <TableCell style={{ width: 160 }} align="center">
                    <div className="d-tble-icons"><Link to={`/bookings/view/${item._id}`}><span className="view-icon"><VisibilityIcon /></span></Link> &nbsp;<Link className="edit-icon-link-pm" to={`/bookings/edit/${item._id}`}><span className="edit-icon-pm"><EditIcon /></span> </Link> &nbsp;<span onClick={(id) => deletePackage(item._id)} className="delete-icon"><DeleteIcon /></span></div>
                  </TableCell>
                </TableRow>
              ))}
